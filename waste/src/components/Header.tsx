...
const clientId = "BMu1LS-QGSfB-t_gkgVFH5kQul-0yY2IObaVeqLJWZyeAAA3dkIZQBDWVkmIXe9j28Ore76uhlIY8oX-0SN6ljY";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">ClearWaste</span>
